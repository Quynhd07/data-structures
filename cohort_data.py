...
def hogwarts_by_house(filename):
    ...
    # split by '|'
    # if order[2] == house, append last name to house list 
    # sort each list 
    # concat list into all_hogwarts
    # return all_hogwarts
    ...
    dumbledores_army = dumbledores_army.sort()
